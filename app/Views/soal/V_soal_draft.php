        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped" id="tbl-draft">
                        <thead>
                            <tr>
                            ...
                            foreach ($drafts as $d): ?>
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 13%">
                                        <button class="btn btn-sm btn-warning" data-toggle="tooltip" title="Edit Draft"
                                            onclick="location.href='<?= base_url(bin2hex('data-draft') . '/' . bin2hex('edit') . '/' . $d['id_draft']) ?>'">
                                            <i class="fas fa-pen"></i>
                                        </button>
                                        <button class="btn btn-sm btn-danger" data-toggle="tooltip" title="Hapus Soal"
                                            onclick="hapus('<?= $d['id_draft'] ?>','<?= $d['judul'] ?>')">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    </td>
                                    <td><?= esc($d['judul']) ?></td>
                                    <td class="text-center"><span
                                            class="badge badge-secondary"><?= esc($d['status']) ?></span></td>
